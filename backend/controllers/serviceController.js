...
const seedDatabase = async () => {
  try {
    ...
    if (count === 0) {
      ...
      console.log(`ℹ️  ${count} services already exist, skipping service seed.`);
    }
    ...
    if (profCount === 0) {
      ...
      const dummyProfessionals = [
        // Spa
        { name: "Aria Montgomery",  category: "Spa",        rating: 4.9, experience: 5,  image: "https://randomuser.me/api/portraits/women/44.jpg", status: "Available" },
        { name: "Priya Sharma",     category: "Spa",        rating: 4.8, experience: 3,  image: "https://randomuser.me/api/portraits/women/65.jpg", status: "Available" },
        { name: "Nina Kapoor",      category: "Spa",        rating: 4.7, experience: 6,  image: "https://randomuser.me/api/portraits/women/68.jpg", status: "Available" },
        // Electrician
        { name: "David Vance",      category: "Electrician", rating: 4.8, experience: 8,  image: "https://randomuser.me/api/portraits/men/32.jpg", status: "Available" },
        { name: "Rajan Mehta",      category: "Electrician", rating: 4.7, experience: 5,  image: "https://randomuser.me/api/portraits/men/45.jpg", status: "Available" },
        { name: "Samuel Torres",    category: "Electrician", rating: 4.6, experience: 7,  image: "https://randomuser.me/api/portraits/men/55.jpg", status: "Available" },
        // Carpentry
        { name: "John Carpenter",   category: "Carpentry",  rating: 4.7, experience: 12, image: "https://randomuser.me/api/portraits/men/22.jpg", status: "Available" },
        { name: "Vikram Singh",     category: "Carpentry",  rating: 4.8, experience: 9,  image: "https://randomuser.me/api/portraits/men/67.jpg", status: "Available" },
        { name: "Arun Pillai",      category: "Carpentry",  rating: 4.6, experience: 4,  image: "https://randomuser.me/api/portraits/men/71.jpg", status: "Available" },
        // Plumbing
        { name: "Robert Wade",      category: "Plumbing",   rating: 4.6, experience: 6,  image: "https://randomuser.me/api/portraits/men/36.jpg", status: "Available" },
        { name: "Suresh Kumar",     category: "Plumbing",   rating: 4.7, experience: 10, image: "https://randomuser.me/api/portraits/men/43.jpg", status: "Available" },
        { name: "James Patel",      category: "Plumbing",   rating: 4.5, experience: 3,  image: "https://randomuser.me/api/portraits/men/81.jpg", status: "Available" },
        // Security
        { name: "Marcus Shield",    category: "Security",   rating: 4.9, experience: 9,  image: "https://randomuser.me/api/portraits/men/14.jpg", status: "Available" },
        { name: "Kiran Nair",       category: "Security",   rating: 4.8, experience: 7,  image: "https://randomuser.me/api/portraits/men/29.jpg", status: "Available" },
        // Repair
        { name: "Elena Rostova",    category: "Repair",     rating: 4.8, experience: 4,  image: "https://randomuser.me/api/portraits/women/12.jpg", status: "Available" },
        { name: "Meera Iyer",       category: "Repair",     rating: 4.7, experience: 6,  image: "https://randomuser.me/api/portraits/women/33.jpg", status: "Available" },
        { name: "Asha Reddy",       category: "Repair",     rating: 4.6, experience: 5,  image: "https://randomuser.me/api/portraits/women/57.jpg", status: "Available" },
        // General (fallback for custom/unknown category)
        { name: "Raj Kumar",        category: "General",    rating: 4.5, experience: 3,  image: "https://randomuser.me/api/portraits/men/90.jpg", status: "Available" },
        { name: "Anita Desai",      category: "General",    rating: 4.6, experience: 5,  image: "https://randomuser.me/api/portraits/women/90.jpg", status: "Available" },
      ];

      await Professional.insertMany(dummyProfessionals);
      console.log("Professionals seeded successfully!");
    } else {
      console.log(`ℹ️  ${profCount} professionals already exist, skipping professional seed.`);
    }
  } catch (error) {
